...
// SpriteEditorView.cpp: CSpriteEditorView 클래스의 구현
//
...
BEGIN_MESSAGE_MAP(CSpriteEditorView, CView)
	...
	ON_COMMAND(ID_FILE_PRINT_PREVIEW, &CSpriteEditorView::OnFilePrintPreview)
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
END_MESSAGE_MAP()

// CSpriteEditorView 생성/소멸

CSpriteEditorView::CSpriteEditorView() noexcept
{
...
// CSpriteEditorView 인쇄


void CSpriteEditorView::OnFilePrintPreview()
{
#ifndef SHARED_HANDLERS
...
void CSpriteEditorView::OnRButtonUp(UINT /* nFlags */, CPoint point)
{
	ClientToScreen(&point);
	OnContextMenu(this, point);
}

void CSpriteEditorView::OnContextMenu(CWnd* /* pWnd */, CPoint point)
{
#ifndef SHARED_HANDLERS
...
CSpriteEditorDoc* CSpriteEditorView::GetDocument() const // 디버그되지 않은 버전은 인라인으로 지정됩니다.
{
