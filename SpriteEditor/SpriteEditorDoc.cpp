...
// SpriteEditorDoc.cpp: CSpriteEditorDoc 클래스의 구현
//
...
// CSpriteEditorDoc 생성/소멸

CSpriteEditorDoc::CSpriteEditorDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CSpriteEditorDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CSpriteEditorDoc::InitializeSearchContent()
{
...
void CSpriteEditorDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
